    ...
    <div class="max-w-4xl mx-auto p-4">
        ...
        <div class="flex space-x-4 mb-4">
            <div class="flex-1">
                ...
                <input type="text" id="product-title" name="title" value="{{$item->title}}"
            ...
            <div class="flex-1">
                ...
                <input type="number" id="product-price" name="price" value="{{$item->price}}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
            </div>
            <div class="flex-1">
                <label for="product-stock" class="block text-sm font-medium text-gray-700">Stock</label>
                <input type="number" id="product-stock" name="stock"  value="{{$item->stock}}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
            </div>
        </div>
